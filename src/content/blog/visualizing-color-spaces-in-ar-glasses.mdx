...
For color mixing, this means visualizing all three color dimensions simultaneously as you work. The tool for this is a color space: a 3D coordinate system where every possible color occupies a unique position. For a comprehensive introduction to <ReferencePreview client:load trigger="color spaces, models and gamuts" href="https://www.makingsoftware.com/chapters/color-spaces-models-and-gamuts" imageSrc="/assets/visualizing-color-spaces-in-ar-glasses/captures/dan-hollick-col-spaces.png" imageAlt="Color Spaces, Models, and Gamuts by Dan Hollick" refNumber={1} />, I highly recommend Dan Hollick's excellent article.
...
<Chapter client:load id="chapter-3" number={3} title="VFX Particles">
...
<Chapter client:load id="chapter-4" number={4} title="Procedural Meshes">
