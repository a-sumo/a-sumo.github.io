...
ogImage: /assets/visualizing-color-spaces-in-ar-glasses/color-spaces-og.gif
icon: /assets/visualizing-color-spaces-in-ar-glasses/color-space-logo.png
draft: false
---
...
<img
	src="/assets/visualizing-color-spaces-in-ar-glasses/color-spaces-og.gif"
	alt="Visualizing Color Spaces in Augmented Reality"
	...
	chapters={[
		{
			...
			type: "chapter",
			summary: [
				"Why pigment mixing is harder than digital",
				"Interactive color mixing challenge",
			],
			preview: "/assets/visualizing-color-spaces-in-ar-glasses/sc-color-spaces-chapter-1.png",
		},
		{
			id: "chapter-2",
			label: "Building Color Spaces",
			type: "chapter",
			summary: [
				"Why AR glasses for seeing spaces",
				"CIELAB vs RGB for perceptual accuracy",
			],
			preview: "/assets/visualizing-color-spaces-in-ar-glasses/sc-color-spaces-chapter-2.png",
		},
		{
			id: "chapter-3",
			label: "VFX Particles",
			type: "chapter",
			summary: [
				"Encoding color data for particles",
				"Performance limitations",
			],
			preview: "/assets/visualizing-color-spaces-in-ar-glasses/sc-color-spaces-chapter-3.png",
		},
		{
			id: "chapter-4",
			...
			type: "chapter",
			summary: [
				"High-performance rendering solution",
				"Full color space, gamut, and projection",
			],
			preview: "/assets/visualizing-color-spaces-in-ar-glasses/sc-color-spaces-chapter-4.png",
		},
	]}
/>
...
>
	...
	>
		<img
			src="/assets/icons/snapcode-color-spaces.png"
			width="96"
			height="96"
			alt="Snapcode"
		/>
...
<Chapter client:visible id="chapter-1" number={1} title="The Challenge of Color Mixing">
...
<div id="color-mixing-challenge" style={{ scrollMarginTop: "80px" }}>
	<ColorMixingChallenge client:visible targetColor="#8B4513" />
</div>
...
<div
	...
	style={{ background: "rgb(255, 248, 222)", border: "2px solid rgb(40, 39, 40)", padding: "20px 24px 20px 48px", borderRadius: "8px", margin: "24px 0" }}
>
	<ol style={{ margin: 0, paddingLeft: 0, color: "rgb(40, 39, 40)", lineHeight: 1.8, listStylePosition: "outside" }}>
		<li id="q-color-range">
			<strong>What does the full range of perceivable colors look like?</strong>
		</li>
		<li id="q-gamut">
			<strong>Which colors can I achieve with the pigments on my palette?</strong>
		</li>
		<li id="q-projection">
			<strong>How close can I get to a target color given my available pigments?</strong>
		</li>
	</ol>
</div>
...
<Chapter client:visible id="chapter-2" number={2} title="Building Color Spaces">

For color mixing, this means visualizing all three color dimensions simultaneously as you work. The tool for this is a color space: a 3D coordinate system where every possible color occupies a unique position. For a comprehensive introduction to <ReferencePreview client:visible trigger="color spaces, models and gamuts" href="https://www.makingsoftware.com/chapters/color-spaces-models-and-gamuts" imageSrc="/assets/visualizing-color-spaces-in-ar-glasses/captures/dan-hollick-col-spaces.png" imageAlt="Color Spaces, Models, and Gamuts by Dan Hollick" refNumber={1} />, I highly recommend Dan Hollick's excellent article.
...
<Chapter client:visible id="chapter-3" number={3} title="VFX Particles">
...
Later on it occured to me that the mapping between color spaces has interesting is continous. In other words, nearby colors stay nearby. 
Put simply, if you render grid lines for an RGB cube, you can deform them into LAB space and they'll stretch and bend, but never break.
...
I could simply define one layout and deform it to achieve the others.

</Chapter>

<Chapter client:visible id="chapter-4" number={4} title="Procedural Meshes">
...
To make the process of low-level geometry construction and manipulation more, let's say... humane, I used a coding agent supplemented with a <CollapsibleCode client:visible src="/assets/visualizing-color-spaces-in-ar-glasses/scripts/custom_code_node_spec.md" trigger="Custom Code Node specification" language="glsl" />.
...
<div style={{ background: "rgb(248, 248, 250)", border: "1px solid rgb(220, 220, 225)", borderRadius: "8px", padding: "20px 24px", margin: "24px 0" }}>

**[1]** Dan Hollick, ["Color Spaces, Models, and Gamuts"](https://www.makingsoftware.com/chapters/color-spaces-models-and-gamuts) — An excellent, accessible introduction to understanding how color works in digital systems. Highly recommended for anyone wanting to build intuition about color.

</div>

---

## Up next: Image Processing Pipeline on Spectacles
