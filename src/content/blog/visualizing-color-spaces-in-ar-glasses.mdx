...
These three dimensions are independent, or in technical terms, orthogonal. In theory, you can vary along one dimension while keeping others constant.
This is how most digital color pickers work: you pick a hue on one axis and adjust saturation and lightness on another.
...
But with physical pigments, it's not so simple. For example, in order to de-saturate the green color of a tree as it vanishes into the horizon, you'll generally want to add a colder color to it, such as blue.
...
This navigation is crucial because it directly impacts the confidence of your brushstrokes and the fluidity of your artwork.
The more problems you can solve ahead of laying your brush on the canvas, the more enjoyable the process for you, the painter, and the more free-flowing your painting will _feel_ to the viewer.
...
On the other hand, the more pigments you have, the more degrees of freedom, and hence more complexity. This complexity grows combinatorially: not only do you have more possible mixtures to consider, but many different mixtures can yield the same color!
...
Mastering all these considerations takes years of practice.
...
The kind of problem I described above is well-suited to what Bret Victor calls a [Seeing Space](https://worrydream.com/SeeingSpaces/): an environment that makes the invisible visible, letting you see the full range of possibilities at once rather than guessing blindly.

When you combine an axis for each color dimension, you get a color space: a seeing space for color.
There are a wide variety of color spaces, but the ones that matter for painting are those that are perceptually accurate.
Transitions between colors are particularly important as they inform mixing decisions.

To answer the questions from Chapter 1, I needed a way to visualize color spaces while painting.
AR glasses seemed ideal since they keep your hands free and integrate smoothly into the messy flow of painting.
