...
<div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "8px", maxWidth: "600px", margin: "16px auto" }}>
	<div style={{ textAlign: "center" }}>
		<video src="/assets/visualizing-vector-fields-on-ar-glasses/sprites/contraction_animated.webm" autoPlay loop muted playsInline style={{ width: "100%", borderRadius: "8px" }} />
		<p style={{ fontSize: "0.75em", color: "#888", margin: "4px 0" }}>Contraction</p>
	</div>
	<div style={{ textAlign: "center" }}>
		<video src="/assets/visualizing-vector-fields-on-ar-glasses/sprites/expansion_animated.webm" autoPlay loop muted playsInline style={{ width: "100%", borderRadius: "8px" }} />
		<p style={{ fontSize: "0.75em", color: "#888", margin: "4px 0" }}>Expansion</p>
	</div>
	<div style={{ textAlign: "center" }}>
		<video src="/assets/visualizing-vector-fields-on-ar-glasses/sprites/circulation_animated.webm" autoPlay loop muted playsInline style={{ width: "100%", borderRadius: "8px" }} />
		<p style={{ fontSize: "0.75em", color: "#888", margin: "4px 0" }}>Circulation</p>
	</div>
	<div style={{ textAlign: "center" }}>
		<video src="/assets/visualizing-vector-fields-on-ar-glasses/sprites/vortex_animated.webm" autoPlay loop muted playsInline style={{ width: "100%", borderRadius: "8px" }} />
		<p style={{ fontSize: "0.75em", color: "#888", margin: "4px 0" }}>Vortex</p>
	</div>
	<div style={{ textAlign: "center" }}>
		<video src="/assets/visualizing-vector-fields-on-ar-glasses/sprites/waves_animated.webm" autoPlay loop muted playsInline style={{ width: "100%", borderRadius: "8px" }} />
		<p style={{ fontSize: "0.75em", color: "#888", margin: "4px 0" }}>Waves</p>
	</div>
	<div style={{ textAlign: "center" }}>
		<video src="/assets/visualizing-vector-fields-on-ar-glasses/sprites/magnetic_animated.webm" autoPlay loop muted playsInline style={{ width: "100%", borderRadius: "8px" }} />
		<p style={{ fontSize: "0.75em", color: "#888", margin: "4px 0" }}>Magnetic</p>
	</div>
</div>
...
<summary style={{ cursor: "pointer", color: "#888", fontStyle: "italic" }}>
	AnimatedSpriteSheet.js
</summary>
<div style={{ marginTop: "8px", marginBottom: "16px" }}>
	<a href="/assets/visualizing-vector-fields-on-ar-glasses/scripts/AnimatedSpriteSheet.js" target="_blank" rel="noopener noreferrer" style={{ fontSize: "0.9em", color: "#8ca9ff" }}>View custom code node source</a>
</div>
