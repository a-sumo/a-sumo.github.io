...
<ArticleNavToggle
	...
	chapters={[
		{ id: "chapter-1", label: "Rendering 3D Lines", type: "chapter", summary: ["Procedural tube meshes.", "Vertex normals and GPU interpolation."], preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-manim-procedural-tube-mesh.png" },
		...
		{ id: "chapter-2", label: "GPU Deformation", type: "chapter", summary: ["Object to world space transforms.", "Vertex shader deformation."], preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-chapter-2.png" },
		...
		{ id: "chapter-3", label: "Field Integration", type: "chapter", summary: ["Euler integration for flow lines.", "Field demos."], preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-chapter-3.png" },
		...
		{ id: "chapter-4", label: "Magnetic Field", type: "chapter", summary: ["Dipole field derivation.", "GPU implementation."], preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-chapter-4.png" },
		...
		{ id: "chapter-5", label: "Performance", type: "chapter", summary: ["Optimization strategies.", "Profiling results."], preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-chapter-5.png" },
		{ id: "chapter-6", label: "UX", type: "chapter", summary: ["Interaction design.", "User feedback."], preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-chapter-6.png" },
		{ id: "final-words", label: "Final Words", type: "chapter", summary: ["Summary and next steps."], preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-final-words.png" },
	]}
/>
...
<Note client:load type="important" title="Object to World Transform" collapsible={true} id="object-to-world">
...
<div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: "8px", maxWidth: "500px", margin: "16px auto", padding: "0 16px" }}>
	<div style={{ textAlign: "center", borderRadius: "8px", overflow: "hidden" }}>
		<VideoPlayer client:load src="/assets/visualizing-vector-fields-on-ar-glasses/videos/field_source.mp4" autoPlay={true} loop={true} muted={true} maxWidth="100%" noBorder={true} />
		<p style={{ fontSize: "0.75em", color: "#888", margin: "4px 0" }}>Source</p>
	</div>
	<div style={{ textAlign: "center", borderRadius: "8px", overflow: "hidden" }}>
		<VideoPlayer client:load src="/assets/visualizing-vector-fields-on-ar-glasses/videos/field_saddle.mp4" autoPlay={true} loop={true} muted={true} maxWidth="100%" noBorder={true} />
		<p style={{ fontSize: "0.75em", color: "#888", margin: "4px 0" }}>Saddle</p>
	</div>
	<div style={{ textAlign: "center", borderRadius: "8px", overflow: "hidden" }}>
		<VideoPlayer client:load src="/assets/visualizing-vector-fields-on-ar-glasses/videos/field_double_vortex.mp4" autoPlay={true} loop={true} muted={true} maxWidth="100%" noBorder={true} />
...
<div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))", gap: "8px", maxWidth: "600px", margin: "0 auto", padding: "0 16px" }}>
	<div style={{ textAlign: "center", borderRadius: "8px", overflow: "hidden" }}>
		<VideoPlayer client:load src="/assets/visualizing-vector-fields-on-ar-glasses/videos/contraction.mp4" autoPlay={true} loop={true} muted={true} maxWidth="100%" noBorder={true} />
		<p style={{ fontSize: "0.75em", color: "#888", margin: "4px 0" }}>Contraction</p>
	</div>
	<div style={{ textAlign: "center", borderRadius: "8px", overflow: "hidden" }}>
		<VideoPlayer client:load src="/assets/visualizing-vector-fields-on-ar-glasses/videos/expansion.mp4" autoPlay={true} loop={true} muted={true} maxWidth="100%" noBorder={true} />
		<p style={{ fontSize: "0.75em", color: "#888", margin: "4px 0" }}>Expansion</p>
	</div>
	<div style={{ textAlign: "center", borderRadius: "8px", overflow: "hidden" }}>
		<VideoPlayer client:load src="/assets/visualizing-vector-fields-on-ar-glasses/videos/circulation.mp4" autoPlay={true} loop={true} muted={true} maxWidth="100%" noBorder={true} />
		<p style={{ fontSize: "0.75em", color: "#888", margin: "4px 0" }}>Circulation</p>
	</div>
	<div style={{ textAlign: "center", borderRadius: "8px", overflow: "hidden" }}>
		<VideoPlayer client:load src="/assets/visualizing-vector-fields-on-ar-glasses/videos/vortex.mp4" autoPlay={true} loop={true} muted={true} maxWidth="100%" noBorder={true} />
		<p style={{ fontSize: "0.75em", color: "#888", margin: "4px 0" }}>Vortex</p>
	</div>
	<div style={{ textAlign: "center", borderRadius: "8px", overflow: "hidden" }}>
		<VideoPlayer client:load src="/assets/visualizing-vector-fields-on-ar-glasses/videos/waves.mp4" autoPlay={true} loop={true} muted={true} maxWidth="100%" noBorder={true} />
		<p style={{ fontSize: "0.75em", color: "#888", margin: "4px 0" }}>Waves</p>
	</div>
	<div style={{ textAlign: "center", borderRadius: "8px", overflow: "hidden" }}>
		<VideoPlayer client:load src="/assets/visualizing-vector-fields-on-ar-glasses/videos/magnetic.mp4" autoPlay={true} loop={true} muted={true} maxWidth="100%" noBorder={true} />
