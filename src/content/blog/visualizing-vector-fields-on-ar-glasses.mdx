...
<div style={{ display: "flex", gap: "24px", justifyContent: "center", flexWrap: "wrap", padding: "0 16px" }}>
	<figure style={{ margin: 0, textAlign: "center", flex: "1 1 200px", maxWidth: "280px" }}>
		<img src="/assets/visualizing-vector-fields-on-ar-glasses/videos/NaiveOffset.gif" alt="Naive offset - rings stay horizontal" loading="lazy" decoding="async" style={{ width: "100%", borderRadius: "8px" }} />
		<figcaption style={{ color: "#E63946", fontSize: "14px", marginTop: "8px" }}>Naive offset</figcaption>
	</figure>
	<figure style={{ margin: 0, textAlign: "center", flex: "1 1 200px", maxWidth: "280px" }}>
		<img src="/assets/visualizing-vector-fields-on-ar-glasses/videos/TNBFrame.gif" alt="TNB frame - rings perpendicular to tangent" loading="lazy" decoding="async" style={{ width: "100%", borderRadius: "8px" }} />
