...
<Note client:load type="note" title="GPU Implementation" collapsible={true} defaultOpen={true}>
...
<Note client:load type="tip" title="Magnet Physics Script" collapsible={true}>
