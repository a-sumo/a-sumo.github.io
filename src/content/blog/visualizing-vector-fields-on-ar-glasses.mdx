...
icon: /assets/visualizing-vector-fields-on-ar-glasses/icons/vector-fields-logo.png
draft: false
---
...
import MediaQualityToggle from "@components/MediaQualityToggle";
...
<MediaQualityToggle client:load />

<VideoPlayer
	client:load
	src="/assets/visualizing-vector-fields-on-ar-glasses/videos/VectorFieldPreview.mp4"
	poster="/assets/visualizing-vector-fields-on-ar-glasses/videos/VectorFieldPreview-poster.jpg"
	autoPlay={true}
	loop={true}
	muted={true}
	preload="auto"
...
<ArticleNavToggle
	...
	useAdvancedTimeline={true}
	chapters={[
		{ id: "chapter-1", label: "Rendering 3D Lines", type: "chapter", preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-manim-procedural-tube-mesh.png" },
		{ id: "proc-gen-code", label: "Procedural Code", type: "sidequest", parent: "chapter-1", preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-procedural-generation-code.png" },
		{ id: "chapter-2", label: "Deforming the 3D Lines on the GPU", type: "chapter", preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-chapter-2.png" },
		{ id: "object-to-world", label: "Object to World", type: "sidequest", parent: "chapter-2", preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-manim-3d-line-deformation.png" },
		{ id: "chapter-3", label: "Creating and Integrating a Vector Field", type: "chapter", preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-chapter-3.png" },
		{ id: "contraction", label: "Contraction", type: "sidequest", parent: "chapter-3", preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-demo-contraction.png" },
		{ id: "expansion", label: "Expansion", type: "sidequest", parent: "chapter-3", preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-demo-expansion.png" },
		{ id: "circulation", label: "Circulation", type: "sidequest", parent: "chapter-3", preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-demo-circulation.png" },
		{ id: "vortex", label: "Vortex", type: "sidequest", parent: "chapter-3", preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-demo-vortex.png" },
		{ id: "waves", label: "Waves", type: "sidequest", parent: "chapter-3", preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-demo-waves.png" },
		{ id: "chapter-4", label: "Magnetic Field Visualization", type: "chapter", preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-chapter-4.png" },
		{ id: "math-derivation", label: "Math Derivation", type: "sidequest", parent: "chapter-4", preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-math-dipole-integration.png" },
		{ id: "gpu-implementation", label: "GPU Implementation", type: "sidequest", parent: "chapter-4", preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-gpu-implementation.png" },
		{ id: "magnet-physics", label: "Magnet Physics", type: "sidequest", parent: "chapter-4", preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-magnetic-field-demo.png" },
		{ id: "chapter-5", label: "Performance Considerations", type: "chapter", preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-chapter-5.png" },
		{ id: "chapter-6", label: "UX", type: "chapter", preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-chapter-6.png" },
		{ id: "final-words", label: "Final Words", type: "chapter", preview: "/assets/visualizing-vector-fields-on-ar-glasses/captures/sc-vector-fields-final-words.png" },
	]}
/>
...
2. We can show how tracers move when carried by the flow in real time, which is done via *particles*.
3. Or we can trace the continuous paths these tracers follow through the field, with *flow lines*.

<div id="vector-field-viz">
<VectorFieldViz client:visible fieldType="dipole" />
</div>

<Chapter client:visible id="chapter-1" number={1} title="Rendering 3D Lines" />
...
<ManimVideo
	client:visible
	src="/assets/visualizing-vector-fields-on-ar-glasses/videos/TubeConstruction_alpha.webm"
	codeSrc="/assets/visualizing-vector-fields-on-ar-glasses/manim/tube_construction.py"
	maxWidth="600px"
	noBorder={true}
	transparent={true}
	autoPlay={true}
	caption="Procedural tube mesh construction: vertices, triangles, and end caps"
	figureId="Fig 1.1"
/>

<span id="proc-gen-code"></span>
<Note client:visible type="note" title="Procedural Generation Code" collapsible={true} id="proc-gen-code">
...
<Chapter client:visible id="chapter-2" number={2} title="Deforming the 3D Lines on the GPU" />
...
<div style={{ display: "flex", gap: "24px", justifyContent: "center", flexWrap: "wrap", padding: "0 16px" }}>
	<figure style={{ margin: 0, textAlign: "center", flex: "1 1 200px", maxWidth: "280px" }}>
		<video src="/assets/visualizing-vector-fields-on-ar-glasses/videos/NaiveOffset_alpha.webm" autoPlay loop muted playsInline controls style={{ width: "100%", borderRadius: "8px" }} />
		<figcaption style={{ color: "#E63946", fontSize: "14px", marginTop: "8px" }}>Naive offset</figcaption>
	</figure>
	<figure style={{ margin: 0, textAlign: "center", flex: "1 1 200px", maxWidth: "280px" }}>
		<video src="/assets/visualizing-vector-fields-on-ar-glasses/videos/TNBFrame_alpha.webm" autoPlay loop muted playsInline controls style={{ width: "100%", borderRadius: "8px" }} />
...
<span id="object-to-world"></span>
<Note client:visible type="important" title="Object to World Transform" collapsible={true} id="object-to-world">
...
<figure style={{ margin: "12px 0 0 0", textAlign: "center" }}>
<img src="/assets/visualizing-vector-fields-on-ar-glasses/captures/transform-vector-hue-saturation.png" alt="Material editor showing Transform Vector Object to World node" loading="lazy" decoding="async" style={{ width: "60%", borderRadius: "8px" }} />
<figcaption style={{ fontSize: "0.85em", color: "#888", fontStyle: "italic", marginTop: "8px" }}>Transform Vector and Hue/Saturation nodes in the material editor</figcaption>
</figure>
...
<ManimVideo
	client:visible
	src="/assets/visualizing-vector-fields-on-ar-glasses/videos/TubeDeformation_alpha.webm"
	...
	autoPlay={true}
	loop={true}
	caption="TNB frame deformation preserves tube volume during bending"
	figureId="Fig 2.1"
/>
...
<Chapter client:visible id="chapter-3" number={3} title="Creating and Integrating a Vector Field" />
...
<ManimVideo
	client:visible
	src="/assets/visualizing-vector-fields-on-ar-glasses/videos/FieldContraction_alpha.webm"
...
<ManimVideo
	client:visible
	src="/assets/visualizing-vector-fields-on-ar-glasses/videos/FieldExpansion_alpha.webm"
	codeSrc="/assets/visualizing-vector-fields-on-ar-glasses/manim/vector_field_presets.py"
	maxWidth="600px"
	noBorder={true}
	transparent={true}
...
<ManimVideo
	client:visible
	src="/assets/visualizing-vector-fields-on-ar-glasses/videos/FieldCirculation_alpha.webm"
	codeSrc="/assets/visualizing-vector-fields-on-ar-glasses/manim/vector_field_presets.py"
	maxWidth="600px"
	noBorder={true}
	transparent={true}
...
<ManimVideo
	client:visible
	src="/assets/visualizing-vector-fields-on-ar-glasses/videos/FieldVortex_alpha.webm"
	codeSrc="/assets/visualizing-vector-fields-on-ar-glasses/manim/vector_field_presets.py"
	maxWidth="600px"
	noBorder={true}
	transparent={true}
...
<ManimVideo
	client:visible
	src="/assets/visualizing-vector-fields-on-ar-glasses/videos/FieldWaves_alpha.webm"
	codeSrc="/assets/visualizing-vector-fields-on-ar-glasses/manim/vector_field_presets.py"
	maxWidth="600px"
	noBorder={true}
	transparent={true}
...
<Chapter client:visible id="chapter-4" number={4} title="Magnetic Field Visualization" />
...
<Note client:visible type="note" title="Math: Dipole Field & Integration" collapsible={true} defaultOpen={true} id="math-derivation">
...
<Note client:visible type="note" title="GPU Implementation" collapsible={true} defaultOpen={true} id="gpu-implementation">
...
<ManimVideo
	client:visible
	src="/assets/visualizing-vector-fields-on-ar-glasses/videos/MagneticField_alpha.webm"
...
<Note client:visible type="tip" title="Magnet Physics Script" collapsible={true} id="magnet-physics">
...
<Chapter client:visible id="chapter-5" number={5} title="Performance Considerations" />
...
<Chapter client:visible id="chapter-6" number={6} title="UX" />
...
<div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: "8px", maxWidth: "500px", margin: "16px auto", padding: "0 16px", justifyItems: "center" }}>
	<div style={{ textAlign: "center", borderRadius: "8px", overflow: "hidden", width: "100%", maxWidth: "200px" }}>
		<VideoPlayer client:visible src="/assets/visualizing-vector-fields-on-ar-glasses/videos/field_source.mp4" autoPlay={true} loop={true} muted={true} maxWidth="100%" noBorder={true} />
		<p style={{ fontSize: "0.75em", color: "#888", margin: "4px 0" }}>Source</p>
	</div>
	<div style={{ textAlign: "center", borderRadius: "8px", overflow: "hidden", width: "100%", maxWidth: "200px" }}>
		<VideoPlayer client:visible src="/assets/visualizing-vector-fields-on-ar-glasses/videos/field_saddle.mp4" autoPlay={true} loop={true} muted={true} maxWidth="100%" noBorder={true} />
		<p style={{ fontSize: "0.75em", color: "#888", margin: "4px 0" }}>Saddle</p>
	</div>
	<div style={{ textAlign: "center", borderRadius: "8px", overflow: "hidden", width: "100%", maxWidth: "200px" }}>
		<VideoPlayer client:visible src="/assets/visualizing-vector-fields-on-ar-glasses/videos/field_double_vortex.mp4" autoPlay={true} loop={true} muted={true} maxWidth="100%" noBorder={true} />
...
<div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "8px", maxWidth: "500px", margin: "0 auto", padding: "0 16px" }}>
	<div style={{ textAlign: "center", borderRadius: "8px", overflow: "hidden" }}>
		<VideoPlayer client:visible src="/assets/visualizing-vector-fields-on-ar-glasses/videos/contraction.mp4" autoPlay={true} loop={true} muted={true} maxWidth="100%" noBorder={true} />
		<p style={{ fontSize: "0.7em", color: "#888", margin: "4px 0" }}>Contraction</p>
	</div>
	<div style={{ textAlign: "center", borderRadius: "8px", overflow: "hidden" }}>
		<VideoPlayer client:visible src="/assets/visualizing-vector-fields-on-ar-glasses/videos/expansion.mp4" autoPlay={true} loop={true} muted={true} maxWidth="100%" noBorder={true} />
		<p style={{ fontSize: "0.7em", color: "#888", margin: "4px 0" }}>Expansion</p>
	</div>
	<div style={{ textAlign: "center", borderRadius: "8px", overflow: "hidden" }}>
		<VideoPlayer client:visible src="/assets/visualizing-vector-fields-on-ar-glasses/videos/circulation.mp4" autoPlay={true} loop={true} muted={true} maxWidth="100%" noBorder={true} />
		<p style={{ fontSize: "0.7em", color: "#888", margin: "4px 0" }}>Circulation</p>
	</div>
	<div style={{ textAlign: "center", borderRadius: "8px", overflow: "hidden" }}>
		<VideoPlayer client:visible src="/assets/visualizing-vector-fields-on-ar-glasses/videos/vortex.mp4" autoPlay={true} loop={true} muted={true} maxWidth="100%" noBorder={true} />
		<p style={{ fontSize: "0.7em", color: "#888", margin: "4px 0" }}>Vortex</p>
	</div>
	<div style={{ textAlign: "center", borderRadius: "8px", overflow: "hidden" }}>
		<VideoPlayer client:visible src="/assets/visualizing-vector-fields-on-ar-glasses/videos/waves.mp4" autoPlay={true} loop={true} muted={true} maxWidth="100%" noBorder={true} />
		<p style={{ fontSize: "0.7em", color: "#888", margin: "4px 0" }}>Waves</p>
	</div>
	<div style={{ textAlign: "center", borderRadius: "8px", overflow: "hidden" }}>
		<VideoPlayer client:visible src="/assets/visualizing-vector-fields-on-ar-glasses/videos/magnetic.mp4" autoPlay={true} loop={true} muted={true} maxWidth="100%" noBorder={true} />
		<p style={{ fontSize: "0.7em", color: "#888", margin: "4px 0" }}>Magnetic</p>
	</div>
</div>
...
<div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "8px", maxWidth: "500px", margin: "16px auto", padding: "0 16px" }}>
	<div style={{ textAlign: "center" }}>
		<video poster="/assets/visualizing-vector-fields-on-ar-glasses/sprites/contraction_preview.png" autoPlay loop muted playsInline preload="none" style={{ width: "100%", borderRadius: "8px", background: "transparent" }}>
			<source src="/assets/visualizing-vector-fields-on-ar-glasses/sprites/contraction_animated.webm" type="video/webm" />
		</video>
		<p style={{ fontSize: "0.7em", color: "#888", margin: "4px 0" }}>Contraction</p>
	</div>
	<div style={{ textAlign: "center" }}>
		<video poster="/assets/visualizing-vector-fields-on-ar-glasses/sprites/expansion_preview.png" autoPlay loop muted playsInline preload="none" style={{ width: "100%", borderRadius: "8px", background: "transparent" }}>
			<source src="/assets/visualizing-vector-fields-on-ar-glasses/sprites/expansion_animated.webm" type="video/webm" />
		</video>
		<p style={{ fontSize: "0.7em", color: "#888", margin: "4px 0" }}>Expansion</p>
	</div>
	<div style={{ textAlign: "center" }}>
		<video poster="/assets/visualizing-vector-fields-on-ar-glasses/sprites/circulation_preview.png" autoPlay loop muted playsInline preload="none" style={{ width: "100%", borderRadius: "8px", background: "transparent" }}>
			<source src="/assets/visualizing-vector-fields-on-ar-glasses/sprites/circulation_animated.webm" type="video/webm" />
		</video>
		<p style={{ fontSize: "0.7em", color: "#888", margin: "4px 0" }}>Circulation</p>
	</div>
	<div style={{ textAlign: "center" }}>
		<video poster="/assets/visualizing-vector-fields-on-ar-glasses/sprites/vortex_preview.png" autoPlay loop muted playsInline preload="none" style={{ width: "100%", borderRadius: "8px", background: "transparent" }}>
			<source src="/assets/visualizing-vector-fields-on-ar-glasses/sprites/vortex_animated.webm" type="video/webm" />
		</video>
		<p style={{ fontSize: "0.7em", color: "#888", margin: "4px 0" }}>Vortex</p>
	</div>
	<div style={{ textAlign: "center" }}>
		<video poster="/assets/visualizing-vector-fields-on-ar-glasses/sprites/waves_preview.png" autoPlay loop muted playsInline preload="none" style={{ width: "100%", borderRadius: "8px", background: "transparent" }}>
			<source src="/assets/visualizing-vector-fields-on-ar-glasses/sprites/waves_animated.webm" type="video/webm" />
		</video>
		<p style={{ fontSize: "0.7em", color: "#888", margin: "4px 0" }}>Waves</p>
	</div>
	<div style={{ textAlign: "center" }}>
		<video poster="/assets/visualizing-vector-fields-on-ar-glasses/sprites/magnetic_preview.png" autoPlay loop muted playsInline preload="none" style={{ width: "100%", borderRadius: "8px", background: "transparent" }}>
			<source src="/assets/visualizing-vector-fields-on-ar-glasses/sprites/magnetic_animated.webm" type="video/webm" />
		</video>
		<p style={{ fontSize: "0.7em", color: "#888", margin: "4px 0" }}>Magnetic</p>
	</div>
</div>
...
<div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "12px", maxWidth: "900px", margin: "16px auto", padding: "0 16px" }}>
	<div style={{ textAlign: "center" }}>
		<ExpandableImage
			client:visible
...
<div style={{ display: "flex", justifyContent: "center", margin: "16px 0", padding: "0 16px" }}>
	<img src="/assets/visualizing-vector-fields-on-ar-glasses/captures/animated-sprite-sheet.png" alt="Animated sprite sheet material graph" loading="lazy" decoding="async" style={{ maxWidth: "600px", width: "100%", borderRadius: "8px" }} />
</div>
...
<span id="transparent-test"></span>
## Transparent Animation Test

Testing webp with alpha channel (keyed out black background):

<div style={{ display: "flex", justifyContent: "center", margin: "16px 0" }}>
	<video autoPlay loop muted playsInline style={{ maxWidth: "400px", width: "100%" }}>
		<source src="/assets/visualizing-vector-fields-on-ar-glasses/videos/TestTransparent_alpha.webm" type="video/webm" />
	</video>
</div>
