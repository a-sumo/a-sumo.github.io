...
<ArticleTimeline
  client:load
  sections={[
    { id: "chapter-1", label: "Why an Eyedropper?", type: "chapter" },
    { id: "chapter-2", label: "Implementation", type: "chapter" },
    { id: "chapter-3", label: "UI and Materials", type: "chapter" },
    { id: "chapter-4", label: "Security Considerations", type: "chapter" },
    { id: "chapter-5", label: "Comfort and Ease of Use", type: "chapter" },
    { id: "chapter-6", label: "Code Snippets", type: "chapter" },
  ]}
/>
...
<div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: "24px", flexWrap: "wrap", fontFamily: '"Roboto Mono", monospace', fontSize: "13px" }}>
	...
	<a href="https://www.spectacles.com/lens/563d15eba7dd42609bdcb6ea641d7940?type=SNAPCODE&metadata=01" style={{ display: "inline-flex", alignItems: "center", gap: "8px" }}>
		<img src="/assets/icons/snapcode-eyedropper.svg" width="96" height="96" alt="Snapcode" />
		Try on Spectacles
	</a>
</div>

<Chapter client:load id="chapter-1" number={1} title="Why an Eyedropper?">
...
<Chapter client:load id="chapter-2" number={2} title="Implementation">
...
<Chapter client:load id="chapter-3" number={3} title="UI and Materials">
...
<Chapter client:load id="chapter-4" number={4} title="Security Considerations">
...
<Chapter client:load id="chapter-5" number={5} title="Comfort and Ease of Use">
...
<Chapter client:load id="chapter-6" number={6} title="Code Snippets and References">
