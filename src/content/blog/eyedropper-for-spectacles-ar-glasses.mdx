...
<Chapter client:load number={1} title="Why an Eyedropper?">
...
<Chapter client:load number={2} title="Implementation">
...
<Chapter client:load number={3} title="UI and Materials">
...
<Chapter client:load number={4} title="Security Considerations">
...
<Chapter client:load number={5} title="Comfort and Ease of Use">
...
<Chapter client:load number={6} title="Code Snippets and References">
