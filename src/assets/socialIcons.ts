const socialIcons = {
  ...
  Snapchat: `<svg
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
      <path d="M16.882 7.842a4.882 4.882 0 0 0 -9.764 0c0 4.273 -.213 6.409 -4.118 8.118c2 .882 2 .882 3 3c0 1 0 1 -1 2h3c0 1 1 2 3 2s3 -1 3 -2h3c-1 -1 -1 -1 -1 -2c1 -2.118 1 -2.118 3 -3c-3.906 -1.709 -4.118 -3.845 -4.118 -8.118z"></path>
      <path d="M3 15c2 0 2 -1 2 -1c0 -1 -1 -2 -1 -2"></path>
      <path d="M21 15c-2 0 -2 -1 -2 -1c0 -1 1 -2 1 -2"></path>
    </svg>`,
  Pinterest: `<svg
      xmlns="http://www.w3.org/2000/svg"
      class="icon-tabler"
