const socialIcons = {
  ...
  Snapchat: `<svg
      ...
      viewBox="0 0 512 512"
    >
      <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M256 48c-54.4 0-98.9 38.6-109 89.7l-.2 1c-3.7 18.9-6.8 42.8-6.8 69.3 0 12.7-.6 24-5.5 32.7-4.6 8.2-12.9 14.5-27.5 20.4-4.5 1.8-13.1 4.3-19.8 6.3-14.9 4.4-24.2 7.6-29.4 13.4-5.7 6.4-6.2 14.3-2.4 23.5 6.3 15.3 22.4 22.7 44.1 22.7 6.6 0 13.6-.7 20.3-1.9 9.2-1.7 19.4-4.1 30.4-4.1 7.7 0 14.6.9 21.8 3.5 12.3 4.5 23.2 13.5 37.8 24.7C226.7 361.5 242 372 256 372s29.3-10.5 46.2-22.8c14.6-11.2 25.5-20.2 37.8-24.7 7.2-2.6 14.1-3.5 21.8-3.5 11 0 21.2 2.4 30.4 4.1 6.7 1.2 13.7 1.9 20.3 1.9 21.7 0 37.8-7.4 44.1-22.7 3.8-9.2 3.3-17.1-2.4-23.5-5.2-5.8-14.5-9-29.4-13.4-6.7-2-15.3-4.5-19.8-6.3-14.6-5.9-22.9-12.2-27.5-20.4-4.9-8.7-5.5-20-5.5-32.7 0-26.5-3.1-50.4-6.8-69.3l-.2-1C355 86.6 310.4 48 256 48z"/>
      <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M108 230c20-8 36-24 36-24M404 230c-20-8-36-24-36-24"/>
    </svg>`,
  Pinterest: `<svg
      xmlns="http://www.w3.org/2000/svg"
      class="icon-tabler"
