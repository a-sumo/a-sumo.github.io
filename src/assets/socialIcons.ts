const socialIcons = {
  ...
  Snapchat: `<svg
      ...
      viewBox="0 0 24 24"
    >
      <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 2.5c-3.1 0-5.6 2.2-6.2 5.1-.3 1.4-.4 3-.4 4.9 0 .9 0 1.7-.4 2.3-.3.5-.9 1-2 1.4-.3.1-.9.3-1.3.4-1 .3-1.6.5-2 .9-.4.4-.4 1-.2 1.6.5 1.2 1.7 1.8 3.4 1.8.5 0 1-.1 1.5-.2.7-.1 1.4-.3 2.2-.3.6 0 1.1.1 1.6.3.9.3 1.7 1 2.7 1.8 1 .8 2 1.5 3.1 1.5s2.1-.7 3.1-1.5c1-.8 1.8-1.5 2.7-1.8.5-.2 1-.3 1.6-.3.8 0 1.5.2 2.2.3.5.1 1 .2 1.5.2 1.7 0 2.9-.6 3.4-1.8.2-.6.2-1.2-.2-1.6-.4-.4-1-.6-2-.9-.4-.1-1-.3-1.3-.4-1.1-.4-1.7-.9-2-1.4-.4-.6-.4-1.4-.4-2.3 0-1.9-.1-3.5-.4-4.9-.6-2.9-3.1-5.1-6.2-5.1z"/>
      <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4.5 13.5c1.5-.5 2.5-1.5 2.5-1.5M19.5 13.5c-1.5-.5-2.5-1.5-2.5-1.5"/>
    </svg>`,
  Pinterest: `<svg
      xmlns="http://www.w3.org/2000/svg"
      class="icon-tabler"
